...
bvh_file = "/mnt/data/jsanchez/BlenderAssets/mocaps/CMU_30fps/02_01_walk.bvh"
...
#skel = bpy.data.objects["aerial_evade"]
skel = bpy.data.objects["02_01_walk"]
